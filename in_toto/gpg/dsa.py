...
<Purpose>
  DSA-specific handling routines for signature verfication and key parsing
"""
import binascii
...
def get_pubkey_params(data):
  ...
  if len(prime_p) != prime_p_length:
    raise Exception("This MPI was truncated!")
  ptr += prime_p_length 
  ...
  if len(group_order_q) != group_order_q_length:
    raise Exception("This MPI has been truncated!")
