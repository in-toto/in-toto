...
from in_toto.gpg.common import (parse_pubkey_payload, get_pubkey_bundle,
    parse_pubkey_bundle)
from in_toto.gpg.exceptions import KeyNotFoundError
from in_toto.gpg.constants import (GPG_EXPORT_PUBKEY_COMMAND, 
...
class TestGPGExpiration(unittest.TestCase):
  ...
  def test_gpg_verify_object_with_about_to_expire_key(self):
    ...
    with mock.patch('in_toto.gpg.functions.datetime') as mock_module:
